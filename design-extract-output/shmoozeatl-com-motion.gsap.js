...
//   import { registerEases, reveals } from './shmoozeatl.com-motion.gsap.js';
...
export const eases = {
  custom1: 'M0,0 C0.4,0 0.2,1 1,1', // 364× on page
  easeInOut: 'M0,0 C0.25,0.1 0.25,1 1,1', // 142× on page
  easeOut: 'M0,0 C0.2,0.6 0.3,1 1,1', // 78× on page
  linear: 'M0,0 C0,0 1,1 1,1', // 73× on page
  easeIn: 'M0,0 C0.61,1 0.88,1 1,1', // 3× on page
};
...
export const reveals = {
  fadeIn: (target, vars = {}) => gsap.from(target, { opacity: 0, duration: 0.17, ease: 'custom1', ...vars }),
  slideUp: (target, vars = {}) => gsap.from(target, { opacity: 0, y: 24, duration: 0.17, ease: 'custom1', ...vars }),
  slideDown: (target, vars = {}) => gsap.from(target, { opacity: 0, y: -24, duration: 0.17, ease: 'custom1', ...vars }),
  scaleIn: (target, vars = {}) => gsap.from(target, { opacity: 0, scale: 0.96, duration: 0.17, ease: 'custom1', ...vars }),
  pop: (target, vars = {}) => gsap.from(target, { scale: 0.9, duration: 0.17, ease: 'custom1', ...vars }),
};
...
export function revealOnScroll(targets, vars = {}) {
  return gsap.utils.toArray(targets).map((el) =>
    gsap.from(el, {
      opacity: 0, y: 24, duration: 0.17, ease: 'custom1', ...vars,
