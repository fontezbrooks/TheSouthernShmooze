...
//   import { animations } from './shmoozeatl.com-motion.waapi.js';
...
export const easings = {
  custom1: 'cubic-bezier(0.4, 0, 0.2, 1)', // 364× on page
  easeInOut: 'ease', // 142× on page
  easeOut: 'cubic-bezier(0.2, 0.6, 0.3, 1)', // 78× on page
  linear: 'linear', // 73× on page
  easeIn: 'cubic-bezier(0.61, 1, 0.88, 1)', // 3× on page
};
...
const _timing = { duration: 170, easing: easings.custom1, fill: 'both' };
