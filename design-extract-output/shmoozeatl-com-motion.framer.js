...
//
//   import { transitions, variants } from './shmoozeatl.com-motion.framer';
...
export const easings = {
  custom1: [0.4, 0, 0.2, 1], // 364× on page
  easeInOut: [0.25, 0.1, 0.25, 1], // 142× on page
  easeOut: [0.2, 0.6, 0.3, 1], // 78× on page
  linear: [0, 0, 1, 1], // 73× on page
  easeIn: [0.61, 1, 0.88, 1], // 3× on page
};
...
export const transitions = {
  base:  { duration: 0.17, ease: easings.custom1 },
  fast:  { duration: 0.100, ease: easings.custom1 },
  slow:  { duration: 0.306, ease: easings.custom1 },
  spring: springs.soft,
};
...
export const variants = {
  ...
  stagger: {
    hidden: {},
    show:   { transition: { staggerChildren: 0.043 } },
  },
};
