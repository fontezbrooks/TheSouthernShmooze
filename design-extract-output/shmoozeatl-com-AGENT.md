# You are building UI in the shmoozeatl.com design system.

Source: https://www.shmoozeatl.com/
Extracted by designlang on 2026-06-23.

## Brand at a glance

- title         The Southern Shmooze | Explore Local Businesses Today
- page intent   landing
- material      flat
- design grade  C
...
- secondary   #0099dd
- accent      #f1694f
- neutrals    #000000 · #333333 · #ffffff · #efece6 · #bbbbbb · #cdd5df

## Typography

- families   Bitter · Shrikhand · Roboto · SFico
- weights    400 · 700 · 500
- base size  16px

## Spacing

- scale      1px · 4px · 22px · 30px · 32px · 35px · 38px · 40px · 43px · 48px · 51px · 64px

## Radii

- scale      2px · 12px · 26px · 50px · 300px

## Motion

- durations  75ms · 100ms · 170ms · 300ms
...
- pronoun    you-only
- headings   Title Case
- CTA verbs  join · submit · business · contact · skip · membership
...
Generated by designlang. Re-extract by running `npx designlang shmoozeatl.com`.
