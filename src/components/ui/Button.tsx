...
export function Button({
  ...
  const toneColor =
    tone === 'rust' ? t.colors.rust : tone === 'black' ? t.colors.black : t.colors.text;

  const bg = isPrimary ? t.colors.rust : t.colors.bg;
  ...
  const borderColor = isPrimary ? t.colors.rustDark : tone === 'black' ? t.colors.black : t.colors.rustDark;
