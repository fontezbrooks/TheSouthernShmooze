...
export const YEARS_OPTIONS = [
	...
	{ label: "4 to 9 years", value: "4-9" },
	{ label: "10+ years", value: "10plus" },
] as const;

export const LICENSED_OPTIONS = [
	{ label: "Yes, both", value: "yes" },
	{ label: "Licensed, not insured", value: "license-only" },
	{ label: "Insured, not licensed", value: "insured-only" },
	{ label: "Neither yet", value: "no" },
	{ label: "Not applicable to my trade", value: "na" },
] as const;
